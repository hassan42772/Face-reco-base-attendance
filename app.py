...
def deleteuser():
    ...
    # If all faces are deleted, remove the trained file
...
def start():
    ...
    def capture_attendance():
        ...
        if not cap.isOpened():  # Check if camera is available
        ...
        while ret:
            ...
            if cv2.waitKey(1) == 27:  # Escape key to break the loop
                break
...
# Endpoint to get attendance data dynamically for AJAX update
...
def home():
    # Read the CSV file
    try:
        df = pd.read_csv('Attendance/Attendance-01_05_25.csv')
    except FileNotFoundError:
        return "Attendance CSV file not found!"

    # Convert the DataFrame to a list of dictionaries for easy access in HTML template
